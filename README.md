...
![example API Business Model Canvas filled with the CanvasCreator][examples/Canvas_apiBusinessModelCanvas_en-US.png]
...
![example of German canvas][examples/Canvas_apiBusinessModelCanvas_de-DE.png]
